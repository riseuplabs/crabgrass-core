...
class Wiki::WikisControllerTest < ActionController::TestCase
  ...
  def test_edit
    ...
    get :edit, params: { id: pages(:wiki).data_id }
    ...
    assert_no_difference 'pages(:wiki).updated_at' do
      put :update, params: { id: pages(:wiki).data_id, cancel: 'true' }
    ...
    (1..2).each do |i|
      str = format('text %d for the wiki', i)
      put :update, params: { id: pages(:wiki).data_id, save: true, wiki: { body: str, version: i } }
  ...
  def test_print
    ...
    get :print, params: { id: pages(:wiki).data_id }
