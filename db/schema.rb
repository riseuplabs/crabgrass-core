...
ActiveRecord::Schema.define(version: 20_170_204_202_942) do
  ...
  create_table 'avatars', force: :cascade do |t|
    t.binary  'image_file_data', limit: 4_294_967_295
  ...
  add_index 'castle_gates_keys', %w[castle_id castle_type holder_code], name: 'index_castle_gates_by_castle_and_holder_code'
  ...
  add_index 'channels_users', %w[channel_id user_id], name: 'index_channels_users'
  ...
  create_table 'custom_appearances', force: :cascade do |t|
    t.text     'parameters',        limit: 65_535
    t.integer  'parent_id',         limit: 4
    t.datetime 'created_at'
    t.datetime 'updated_at'
  ...
  create_table 'events', force: :cascade do |t|
    ...
    t.text     'description_html', limit: 16_777_215
  ...
  create_table 'external_videos', force: :cascade do |t|
    ...
    t.text     'media_embed',         limit: 65_535
    t.integer  'page_terms_id',       limit: 4
    t.datetime 'created_at',                        null: false
    t.datetime 'updated_at',                        null: false
  ...
  add_index 'federatings', %w[group_id network_id], name: 'gn'
  add_index 'federatings', %w[network_id group_id], name: 'ng'
  ...
  add_index 'geo_admin_codes', %w[geo_country_id admin1_code], name: 'geo_admin_codes_index', unique: true
  ...
  add_index 'geo_countries', %w[name code], name: 'geo_countries_index', unique: true
  ...
  add_index 'group_participations', %w[group_id page_id], name: 'index_group_participations'
  ...
  add_index 'memberships', %w[group_id user_id], name: 'gu'
  add_index 'memberships', %w[user_id group_id], name: 'ug'
  ...
  create_table 'page_terms', force: :cascade do |t|
    ...
    t.text     'access_ids',         limit: 16_777_215
  ...
  add_index 'page_tools', %w[page_id tool_id], name: 'index_page_tools'
  ...
  add_index 'pages', %w[data_id data_type], name: 'index_pages_on_data_id_and_data_type'
  ...
  create_table 'possibles', force: :cascade do |t|
    t.string  'name',             limit: 255
    t.text    'action',           limit: 16_777_215
  ...
  create_table 'posts', force: :cascade do |t|
    ...
    t.text     'body',          limit: 16_777_215
    t.text     'body_html',     limit: 16_777_215
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.datetime 'deleted_at'
    t.string   'type',          limit: 255
  ...
  add_index 'posts', %w[discussion_id created_at], name: 'index_posts_on_discussion_id'
  ...
  create_table 'profiles', force: :cascade do |t|
    ...
    t.text     'summary_html',           limit: 65_535
    t.integer  'geo_location_id',        limit: 4
    t.integer  'picture_id',             limit: 4
  end

  add_index 'profiles', %w[entity_id entity_type language stranger peer friend foe], name: 'profiles_index'
  add_index 'profiles', %w[wiki_id entity_id], name: 'profiles_for_wikis'
  ...
  add_index 'ratings', %w[rateable_type rateable_id], name: 'fk_ratings_rateable'
  ...
  add_index 'relationships', %w[contact_id user_id], name: 'index_contacts'
  ...
  add_index 'showings', %w[gallery_id asset_id], name: 'ga'
  add_index 'showings', %w[asset_id gallery_id], name: 'ag'
  ...
  create_table 'survey_questions', force: :cascade do |t|
    t.string   'type',       limit: 255
    t.text     'choices',    limit: 65_535
    t.integer  'survey_id',  limit: 4
    t.integer  'position',   limit: 4
    t.string   'label',      limit: 255
    t.text     'details',    limit: 65_535
    t.boolean  'required'
    t.datetime 'created_at'
    t.datetime 'expires_at'
  ...
  add_index 'tasks', %w[page_id position], name: 'index_tasks_on_page_id_and_position'
  ...
  add_index 'thumbnails', %w[parent_id parent_type], name: 'parent_id_and_type'
  ...
  add_index 'user_participations', %w[page_id user_id], name: 'page_and_user', unique: true
  ...
  add_index 'user_settings', %w[receive_digest digest_frequency digest_day], name: 'digest'
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.integer  'version',                   limit: 4, default: 0
    t.binary   'direct_group_id_cache',     limit: 65_535
    t.binary   'all_group_id_cache',        limit: 65_535
    t.binary   'friend_id_cache',           limit: 65_535
    t.binary   'foe_id_cache',              limit: 65_535
    t.binary   'peer_id_cache',             limit: 65_535
    t.binary   'tag_id_cache',              limit: 65_535
    t.string   'language',                  limit: 5
    t.binary   'admin_for_group_id_cache',  limit: 65_535
  ...
  add_index 'votes', %w[possible_id user_id], name: 'index_votes_possible_and_user'
  ...
  create_table 'wiki_versions', force: :cascade do |t|
    ...
    t.datetime 'updated_at'
    t.integer  'user_id',       limit: 4
    t.text     'raw_structure', limit: 65_535
  end

  add_index 'wiki_versions', ['wiki_id'], name: 'index_wiki_versions'
  add_index 'wiki_versions', %w[wiki_id updated_at], name: 'index_wiki_versions_with_updated_at'
