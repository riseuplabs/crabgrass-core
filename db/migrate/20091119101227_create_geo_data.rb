class CreateGeoData < ActiveRecord::Migration
  def self.up
    ...
    add_index(:geo_countries, %i[name code], name: 'geo_countries_index', unique: true)
    add_index(:geo_admin_codes, %i[geo_country_id admin1_code], name: 'geo_admin_codes_index', unique: true)
