class AddIndexes < ActiveRecord::Migration
  def self.up
    ...
    add_index 'contacts', %w[contact_id user_id], name: 'index_contacts'
    ...
    add_index 'links', %w[page_id other_page_id], name: 'index_links_page_and_other_page'

    add_index 'memberships', %w[group_id user_id page_id], name: 'index_memberships'
    ...
    add_index 'tasks', %w[task_list_id completed position], name: 'index_tasks_completed_positions'
    add_index 'tasks_users', %w[user_id task_id], name: 'index_tasks_users_ids'
    ...
    add_index 'user_participations', %w[page_id user_id], name: 'index_user_participations_page_user'
