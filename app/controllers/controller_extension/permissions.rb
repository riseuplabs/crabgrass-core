module ControllerExtension::Permissions
  ...
  module InstanceMethods
    ...
    #
    # This method will display an error if the user may not take the action.
    # Because of this, only use this in authorized? and similar situations where
    # an error message is what you want.
    #
