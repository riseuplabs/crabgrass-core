...
module Pages::BaseHelper
  ...
  def render_page_title
    safe_join returning [] { |ret|
      ret << content_tag(:h1, @page.title)
      ret << link_to_modal(:edit_title.t.titleize, {:url => edit_page_title_path(@page)}, {:class => 'shy inline plain', :icon => 'pencil'}) if may_edit_page?
